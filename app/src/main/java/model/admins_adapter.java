...
public class admins_adapter  extends ArrayAdapter<String[]> {
    Context context;
    int m_ressource;
    ArrayList<String[]> prod;
    ArrayList<String[]> produits1;

    public admins_adapter(Context context,int ressource, ArrayList<String[]> admins)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
       ...
       date.setText("contact: "+produit[3] );
        prix.setText(produit[4]);
