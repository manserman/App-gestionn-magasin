...
import model.fournisseurs_adapter;
import model.fournisseurs_info;
import model.infos_clients;

public class Fournisseurs extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    ListView lv;
    fournisseurs_adapter adapter;//A changer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fournisseurs);//A changer
        drawerlayout=(DrawerLayout)findViewById(R.id.drawerlayout_fournisseurs);
        Toolbar toolbar = findViewById(R.id.toolbar_fournisseurs);//A changer
        toolbar.setTitleTextColor(getResources().getColor(R.color.white));
        toolbar.setTitle("Fournisseurs");//A changer
        setSupportActionBar(toolbar);
        actionBarDrawerToggle = new ActionBarDrawerToggle(this, drawerlayout, toolbar, R.string.drawer_open, R.string.drawer_close);
        drawerlayout.addDrawerListener(actionBarDrawerToggle);
        MySQLiteOpenHelper bd=new MySQLiteOpenHelper(getBaseContext(),null);
        admins=bd.fournisseurs();
        actionBarDrawerToggle.getDrawerArrowDrawable().setColor(getResources().getColor(R.color.white));
        actionBarDrawerToggle.syncState();
        ajouter=(FloatingActionButton)findViewById(R.id.ajouter_fournisseurs);// A changer
        nav_view=drawerlayout.findViewById(R.id.navigation_view);//A changer
        nav_view.bringToFront();
        nav_view.setNavigationItemSelectedListener(this);
        lv=findViewById(R.id.list_fournisseurs);//A changer
        adapter=new fournisseurs_adapter(this,R.layout.list_items,bd.fournisseurs());// A changer
    ...
    {super.onResume();
        MySQLiteOpenHelper bd=new MySQLiteOpenHelper(getBaseContext(),null);
        admins=bd.fournisseurs();
        adapter=new fournisseurs_adapter(this,R.layout.list_items,admins);
        if(admins!=null)
        lv.setAdapter(adapter);
        ajouter.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View t){
                Intent intent=new Intent(getApplicationContext(),Ajout_fournisseur.class);
                Bundle b=getIntent().getExtras();
                intent.putExtras(b);
                b.putInt("type",0);
                intent.putExtras(b);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                fournisseurs_info dialog=new fournisseurs_info();// A changer
    ...
    {return true;}
        ...
        { case R.id.recherche:
            ...
            case R.id.tri_nom_croissant:
                ...
                String sql= "select ID,NOM,PRENOM,TELEPHONE,ADRESSE,MAIL,NUM_IDENTITE from PROVIDER ORDER BY NOM ASC;";
            ...
            case R.id.tri_nom_decroissant:
                item.setChecked(true);
                prods=new ArrayList<>();
                sql= "select ID,NOM,PRENOM,TELEPHONE,ADRESSE,MAIL,NUM_IDENTITE from PROVIDER ORDER BY NOM DESC;";
                ...
                prod[4]= cursor.getString(4);
                prod[5]= cursor.getString(5);
                prod[6]=cursor.getString(6);prods.add(i,prod);
                        i++;
                        cursor.moveToNext();
                    }
            ...
            case R.id.tri_prenom_croissant:
                item.setChecked(true);
                prods=new ArrayList<>();
                sql= "select ID,NOM,PRENOM,TELEPHONE,ADRESSE,MAIL,NUM_IDENTITE from PROVIDER ORDER BY PRENOM ASC;";
                cursor=db.rawQuery(sql,null);
                n=cursor.getCount();
                if(n<=0)
                    prods=null;
            ...
            case R.id.tri_prenom_decroissant:
                item.setChecked(true);
                prods=new ArrayList<>();
                sql= "select ID,NOM,PRENOM,TELEPHONE,ADRESSE,MAIL,NUM_IDENTITE from PROVIDER ORDER BY PRENOM DESC;";
                cursor=db.rawQuery(sql,null);
                n=cursor.getCount();
                if(n<=0)
                    prods=null;
            ...
            case R.id.tri_id_croissant:
                item.setChecked(true);
                prods=new ArrayList<>();
                sql= "select ID,NOM,PRENOM,TELEPHONE,ADRESSE,MAIL,NUM_IDENTITE from PROVIDER ORDER BY ID ASC;";
                cursor=db.rawQuery(sql,null);
                n=cursor.getCount();
                if(n<=0)
                    prods=null;
            ...
            case R.id.tri_id_decroissant:
                item.setChecked(true);
                prods=new ArrayList<>();
                sql= "select ID,NOM,PRENOM,TELEPHONE,ADRESSE,MAIL,NUM_IDENTITE from PROVIDER ORDER BY ID DESC;";
                cursor=db.rawQuery(sql,null);
                n=cursor.getCount();
                if(n<=0)
                    prods=null;
